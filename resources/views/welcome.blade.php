...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <script
      ...
      defer
    ></script>
    <script src="{{ asset('assets/js/assets/js/init-alpine.js') }}"></script>
    <link
      rel="stylesheet"
    ...
    <script
      ...
      defer
    ></script>
    <script src=" {{ asset('assets/js/assets/js/charts-lines.js') }}" defer></script>
    <script src="{{ asset('assets/js/assets/js/charts-pie.js') }}" defer></script>
  </head>
  <body>
        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
          <div class="h-32 md:h-auto md:w-1/2">
            <img
              ...
              src="{{ url('assets/img/login-office.jpeg') }}"
              alt="Office"
            />
            <img
              aria-hidden="true"
